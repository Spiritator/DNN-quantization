...
PE_fault_dict=MXU.gen_PEarray_SA_fault_dict(n_bit=8, fault_type='flip')

#PE_fault_dict=MXU.gen_PEarray_transient_fault_dict(n_bit=8, fault_num=20, fault_type='flip')
