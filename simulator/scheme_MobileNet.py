...
weight_name='../../../../mobilenet_1_0_224_tf_fused_BN.h5.h5'
...
model_augment=[{'weights':weight_name,'nbits':20,'fbits':10,'rounding_method':'nearest','batch_size':batch_size,'quant_mode':'extrinsic'},
...
inference_scheme(QuantizedMobileNetV1FusedBN, model_augment, compile_augment, dataset_augment, result_save_file, multi_gpu=True, gpu_num=2)
